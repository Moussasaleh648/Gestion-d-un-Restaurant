...
export default function CaissierMenu() {
  ...
  const [form, setForm] = useState({
    name: '', description: '', price: '', category: 'Plats',
    emoji: '🍽️', available: true, popular: false
  });
  ...
  const openAdd = () => {
    setEditTarget(null);
    setForm({
      name: '', description: '', price: '', category: activeCategory !== 'all'
        ? activeCategory : 'Plats', emoji: '🍽️', available: true, popular: false
    });
    setShowModal(true);
  };
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p>{menuItems.length} plats enregistrés</p>
        </div>
            ...
            <div style={{ display: 'grid', gap: 16 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div className="form-group">
                  ...
                  <input type="number" min="0" className="form-input" placeholder="3500" value={form.price}
